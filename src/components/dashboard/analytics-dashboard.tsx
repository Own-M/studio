...
import { Bar, BarChart, CartesianGrid, XAxis, YAxis, Pie, PieChart, Cell, Funnel, FunnelChart, LabelList, Line, LineChart } from "recharts";
import { ArrowDownRight, ArrowUpRight, Target, Users, CheckCircle, Clock } from "lucide-react";
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">
                            <span className="text-green-500 font-semibold">+{conversionRate}%</span> conversion rate
                        </p>
                    </CardContent>
                </Card>
                 <Card>
                    ...
                    <CardContent>
                        <div className="text-3xl font-bold">{avgConversionTime} days</div>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7">
                <Card className="col-span-4">
                    <CardHeader>
                        ...
                        <CardDescription>Performance of each advisor based on lead status.</CardDescription>
                    </CardHeader>
                ...
                <Card className="col-span-4 lg:col-span-3">
                    <CardHeader>
                        ...
                        <CardDescription>From total leads to converted customers.</CardDescription>
                    </CardHeader>
                    <CardContent className="mx-auto aspect-square max-h-[350px]">
                        <ChartContainer config={{}} className="w-full h-full">
                            <FunnelChart layout="vertical" data={funnelData} margin={{ top: 40, bottom: 20}}>
                                <ChartTooltip cursor={false} content={<ChartTooltipContent />} />
                                <Funnel dataKey="value" nameKey="name" >
                                    <LabelList position="right" fill="hsl(var(--foreground))" stroke="none" dataKey="name" className="font-semibold text-sm"/>
                                    <LabelList position="center" fill="hsl(var(--primary-foreground))" stroke="none" dataKey="value" className="font-bold text-lg"/>
                                </Funnel>
                            </FunnelChart>
                        </ChartContainer>
                    </CardContent>
